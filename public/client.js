...
(function() {
  var addMenu, backlinks, boxPadding, boxSize, canvas, clear, clickTime, ctx, decrease, draw, eachBranch, edges, expand, firstBranch, force, forceTick, graphLoading, hideMenuItems, increase, initDraw, klyngeWalk, klynger, links, loadKlynge, makeLinks, menuItems, menuSize, movingKlynge, movingMouseMove, movingX, movingX0, movingY, movingY0, nodes, pin, qp, recur, requestKlynge, root, salt, showMenuItems, stopMoving, update, updateKlynge,
    __slice = [].slice;
  ...
  update = function() {
    ...
    return klyngeWalk(root, 50, handleResult, handleResult);
  };
