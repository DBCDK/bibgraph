...
(function() {
  var $graph, addMenu, boxSize, canvas, ctx, draw, edgeTry, edges, existing, expand, findEdges, force, forceTick, hideMenuItems, initDraw, klynger, menuItems, movingKlynge, movingMouseMove, movingX, movingX0, movingY, movingY0, nNodes, pick, qp, requestKlynge, reset, search, showMenuItems, start, startDrawing, stopMoving, update, _pickN,
    __slice = [].slice;
