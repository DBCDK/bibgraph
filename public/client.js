...
(function() {
  var $graph, addMenu, boxSize, canvas, ctx, draw, edgeTry, edges, existing, expand, findEdges, force, forceTick, initDraw, klynger, movingKlynge, movingMouseMove, movingX, movingX0, movingY, movingY0, nNodes, pick, qp, requestKlynge, reset, search, start, startDrawing, stopMoving, update, _pickN,
    __slice = [].slice;
