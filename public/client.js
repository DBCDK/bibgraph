...
(function() {
  var $graph, addMenu, boxSize, canvas, ctx, draw, edgeTry, edges, existing, expand, klynger, movingKlynge, movingMouseMove, movingX, movingX0, movingY, movingY0, nNodes, pick, qp, requestKlynge, reset, search, start, stopMoving, update, updateForce, _pickN,
    __slice = [].slice;
  ...
  draw = function() {
    var $canvas, $div, a, b, force, h, i, idx, klynge, n, size, svg, w, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _n, _ref, _ref1;
